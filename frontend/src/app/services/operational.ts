...
export const operationalService = {
    fetchReorderAlerts: async (vendorId?: number): Promise<ReorderAlert[]> => {
        const url = vendorId ? `${API_BASE_URL}/reorder-alerts?vendorId=${vendorId}` : `${API_BASE_URL}/reorder-alerts`;
    ...
    fetchOperationalDetails: async (vendorId?: number, alertLevel?: string): Promise<ReorderAlert[]> => {
